...
data = pd.read_csv("yourPath/Forest_TrialStructure/Assets/StreamingAssets/data/exampledata.csv", sep =';', skipinitialspace=True)
#documentation:
...
supplement = pd.read_csv("yourPath/Forest_TrialStructure/Assets/StreamingAssets/data/examplesupplement.csv", sep =';', skipinitialspace=True)
#documentation:
